    ...
    return (<>
     <div className="fixed flex flex-col top-12 left-0 w-14 hover:w-64 md:w-64  bg-white dark:bg-gray-900 h-full  transition-all duration-300  z-80 sidebar ">
        ...
        <div className="flex items-center justify-between px-8 py-5">
            ...
            <div className="mr-2 ">
                <Link href="/writer/profile" className="dark:hover:text-primary hover:text-primary transition-colors duration-200 ease-in-out text-[1.00rem]  dark:text-neutral-400/90 text-secondary-inverse">Robert Jason</Link>
        ...
        <div className="relative  my-5 ">
            ...
            <li className='px-2'>
          <Link href="/" className="relative bg-gray-200  flex flex-row items-center h-11 focus:outline-none  text-gray-600 hover:text-gray-800 border-l-4 border-transparent">
            ...
            <span className="ml-2 text-sm text-black tracking-wide truncate">Home</span>
          </Link>
        </li>
        <li>
        ...
        <li>
          <a href="#" className="relative flex flex-row items-center h-11 focus:outline-none  text-gray-600 hover:text-gray-800 border-l-4 border-transparent">
            ...
            <span className="ml-2 text-sm tracking-wide truncate">Editor</span>
          </a>
        </li>
        <li>
          <a href="#" className="relative flex flex-row items-center h-11 focus:outline-none  text-gray-600 hover:text-gray-800 border-l-4 border-transparent">
            ...
            <span className="ml-2 text-sm tracking-wide truncate">Bookmark</span>
          </a>
        </li>
        <li>
          <a href="#" className="relative flex flex-row items-center h-11 focus:outline-none  text-gray-600 hover:text-gray-800 border-l-4 border-transparent">
            ...
            <span className="ml-2 text-sm tracking-wide truncate">Like</span>
          </a>
        </li>
