...
<header className="bg-white dark:bg-gray-900">
    ...
    <div className="container flex flex-col py-10 mx-auto space-y-6 lg:h-[28rem] lg:py-16 lg:flex-row lg:items-center gap-x-12">
        <div className="w-full ">
            <div className="">
                <h1 className="text-3xl font-semibold tracking-wide text-gray-800 dark:text-white">Find your premium new glasses exported from US</h1>
