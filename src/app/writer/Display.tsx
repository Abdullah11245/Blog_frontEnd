export const Display = () =>{
    return (<>
    <div
  className="group flex flex-col justify-start items-start gap-2 w-96 h-56 duration-500 relative rounded-lg p-4 bg-white border hover:-translate-y-2 hover:shadow-xl shadow-gray-300"
>


  <div className="">
    <div className="flex justify-between items-center">
    <h2 className="text-2xl font-bold  text-gray-800">Dolor</h2>
    <div className="bg-gray-400 w-12 h-12 rounded-full"></div>
    </div>
    

    <p className="text-lg text-gray-400">Consectetur adipiscing elit</p>
    ...
    <div className="mt-2">
    <p className="text-sm text-gray-700 font-semibold">Follow us on</p>
