...
export const PieChart: React.FC = () => {
    ...
    const chartInstance = useRef<Chart<"doughnut"> | undefined>();  
    useEffect(() => {
      const data = {
...
<div className=" w-full  rounded-lg  dark:bg-gray-800 p-4 md:p-6">
  <div className="flex justify-between mb-3">
    <div className="flex items-center">
      <div className="flex justify-center items-center">
        <h5 className="text-xl font-bold leading-none text-gray-900 dark:text-white pe-1">Your Uploads's progress</h5>
  ...
  <div className="bg-gray-50 dark:bg-gray-700 p-3 rounded-lg">
    <div className="grid grid-cols-4 gap-3 mb-2">
      <dl className=" dark:bg-gray-600 rounded-lg flex flex-col items-center justify-center h-16">
        ...
        <dd className="text-orange-600  text-xs font-medium">To do</dd>
      </dl>
      <dl className=" dark:bg-gray-600 rounded-lg flex flex-col items-center justify-center h-16">
        ...
        <dd className="text-teal-600 dark:text-teal-300 text-xs font-medium">In progress</dd>
      </dl>
      <dl className=" dark:bg-gray-600 rounded-lg flex flex-col items-center justify-center h-16">
        ...
        <dd className="text-blue-600 dark:text-blue-300 text-xs font-medium">Done</dd>
      </dl>
      <dl className=" dark:bg-gray-600 rounded-lg flex flex-col items-center justify-center h-16">
        <dt className="w-8 h-8 rounded-full bg-red-100 dark:bg-gray-500 text-red-600 dark:text-blue-300 text-sm font-medium flex items-center justify-center mb-1">64</dt>
        <dd className="text-red-600 dark:text-blue-300 text-xs font-medium">Cancelled</dd>
      </dl>
    </div>
  ...
  <div className="w-64 h-64 mx-auto my-4">
    <canvas id="donut-chart" ref={canvasRef} ></canvas>
</div>
